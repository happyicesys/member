<template>
    <GuestLayout>
        ...
        <section class="text-white rounded my-2 px-2">
            <img src="/images/banner_5.jpg" alt="DCVend Banner" class="w-full rounded hidden md:block" />
            <img src="/images/banner_mobile_5.jpg" alt="DCVend Banner Mobile" class="w-full rounded md:hidden">
        </section>
